...
class CreateEmployeeUseCase {
    ...
    async execute(data: ICreateEmployeeDTO) {
        ...
        data.subsidy_night = data.subsidy_night ?? 0 as any
        data.subsidy_risk = data.subsidy_risk ?? 0 as any
        data.subsidy_attendance = data.subsidy_attendance ?? 0 as any
        data.subsidy_performance = data.subsidy_performance ?? 0 as any
        data.subsidy_leadership = data.subsidy_leadership ?? 0 as any
        data.subsidy_commission = data.subsidy_commission ?? 0 as any
        data.ipa_employee = data.ipa_employee ?? 0 as any
