...
exports.ExportExcelPayrollController = void 0;
const tsyringe_1 = require("tsyringe");
const ExportExcelPayrollUseCase_1 = require("./ExportExcelPayrollUseCase");
const exceljs_1 = __importDefault(require("exceljs"));
class ExportExcelPayrollController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { year, month } = request.body;
            const exportExcelPayrollUseCase = tsyringe_1.container.resolve(ExportExcelPayrollUseCase_1.ExportExcelPayrollUseCase);
            const payrolls = yield exportExcelPayrollUseCase.execute(year, month);
            try {
...
exports.ExportExcelPayrollController = ExportExcelPayrollController;
