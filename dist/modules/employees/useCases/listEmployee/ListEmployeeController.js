...
class ListEmployeeController {
    handle(request, response) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const listEmployeeUseCase = tsyringe_1.container.resolve(ListEmployeeUseCase_1.ListEmployeeUseCase);
            const employees = yield listEmployeeUseCase.execute(user_id);
