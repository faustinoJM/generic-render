...
exports.ListEmployeeUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const AppError_1 = __importDefault(require("../../../../shared/errors/AppError"));
let ListEmployeeUseCase = class ListEmployeeUseCase {
    ...
    execute(user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const users = yield this.employeeRepository.list(user.company_id);
            return users;
        });
    }
};
ListEmployeeUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("EmployeesRepository")),
    __param(1, (0, tsyringe_1.inject)("UsersRepository")),
    __metadata("design:paramtypes", [Object, Object])
], ListEmployeeUseCase);
exports.ListEmployeeUseCase = ListEmployeeUseCase;
