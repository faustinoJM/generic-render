...
class DeleteEmployeeController {
    handle(request, response) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(id);
            const deleteEmployeeUseCase = tsyringe_1.container.resolve(DeleteEmployeeUseCase_1.DeleteEmployeeUseCase);
            const employee = yield deleteEmployeeUseCase.execute(id, user_id);
