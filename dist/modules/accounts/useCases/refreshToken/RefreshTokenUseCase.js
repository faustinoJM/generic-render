...
let RefreshTokenUseCase = class RefreshTokenUseCase {
    ...
    execute(token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userToken) {
                throw new AppError_1.default("Refresh Token doesn't exists");
            }
            ...
            const refresh_token_expires_date = this.dayjsDateProvider.addDays(auth_1.default.expires_refresh_token);
