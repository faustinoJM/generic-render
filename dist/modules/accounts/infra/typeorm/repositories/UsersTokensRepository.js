...
class UsersTokensRepository {
    constructor() {
        this.repository = typeorm_1.AppDataSource.getRepository(UserTokens_1.UserTokens);
    }
    create({ user_id, expires_date, refresh_token, company_id }) {
    ...
    findByRefreshToken(refresh_token) {
        return __awaiter(this, void 0, void 0, function* () {
            const userToken = yield this.repository.findOne({
                where: { refresh_token }
            });
            return userToken;
        });
